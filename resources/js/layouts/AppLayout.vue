...
<template>
    <div class="min-h-screen flex bg-gray-50 dark:bg-gray-900">
        ...
        >
            ...
            <div class="flex items-center h-16 px-4 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center gap-3">
                    ...
                    <span v-if="sidebarOpen" class="text-lg font-bold text-gray-900 dark:text-white">PlanHive</span>
                </div>
            </div>
            ...
            <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
                ...
                >
                    ...
                    <span v-if="sidebarOpen">{{ t(item.name) }}</span>
                </Link>
            </nav>
            ...
            <div class="p-2 border-t border-gray-200 dark:border-gray-700">
                ...
                >
                    <svg v-if="sidebarOpen" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 19l-7-7 7-7m8 14l-7-7 7-7"/></svg>
        ...
        <!-- Main Content -->
        <div :class="['flex-1 transition-all duration-300', sidebarOpen ? 'ml-64' : 'ml-16']">
            <!-- Top Header -->
                    ...
                    <div class="flex-1 max-w-lg">
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                            />
                        </div>
                    </div>
            ...
            <div v-if="flash?.success" class="mx-6 mt-4">
                <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 text-green-800 dark:text-green-300 text-sm">
                    {{ flash.success }}
                </div>
            </div>
            <div v-if="flash?.error" class="mx-6 mt-4">
                <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4 text-red-800 dark:text-red-300 text-sm">
                    {{ flash.error }}
                </div>
            </div>
