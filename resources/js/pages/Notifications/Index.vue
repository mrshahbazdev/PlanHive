...
const timeAgo = (date) => {
    ...
    if (seconds < 3600) return t('notifications.m_ago', { n: Math.floor(seconds / 60) });
    if (seconds < 86400) return t('notifications.h_ago', { n: Math.floor(seconds / 3600) });
    return t('notifications.d_ago', { n: Math.floor(seconds / 86400) });
};
</script>
